...
$sql = "SELECT UseOrder,history.SongID,Title,Tagged,OrigTitle,Tempo,SongKey,Source,Audio,".
...
echo "</tr></table><br>\n";
echo "<input type=submit value=\"Update tags according to checkboxes above\">&nbsp;&nbsp;&nbsp;&nbsp;";
echo "<input type=hidden name=\"sid_list\" value=\"".substr($sid_list,1)."\">";
echo "<input type=button value=\"Go to action page with this session\" ";
