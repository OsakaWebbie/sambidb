...
?>
    ...
    <form action="pdflayout.php" method="get" name="optionsform" target="_blank">
      ...
      <div style="float:left; margin-right:10px">
        <input type="radio" name="pattern" value="basic" border="0">Basic song content (stuff before ---)<br>
        <input type="radio" name="pattern" value="allparts" border="0" checked>Basic + Extras<br>
